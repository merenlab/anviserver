...
from main.views import projects, index, interactive, teams, profile
...
urlpatterns = [
    ...
    url(r'^(?P<username>\w+)/(?P<project_name>[\w|\ \-]+)/download', interactive.download_zip, name="download_zip"),
