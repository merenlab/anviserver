            ...
            case "ArrowLeft":
                {
                    ...
                    if (focusable) {
                        ...
                        e.preventDefault();
                        e.stopPropagation();
                        if (focusMode === "cell" && direction === "rtl") (0, $2oePb$reactariafocus.focusSafely)(ref.current);
                        else {
                            walker.currentNode = ref.current;
                            focusable = direction === "rtl" ? walker.firstChild() : $cf2021be63b01ef4$var$last(walker);
                            if (focusable) (0, $2oePb$reactariafocus.focusSafely)(focusable);
                        }
                    }
                    break;
                }
            case "ArrowRight":
                {
                    ...
                    if (focusable1) {
                        ...
                        e.preventDefault();
                        e.stopPropagation();
                        if (focusMode === "cell" && direction === "ltr") (0, $2oePb$reactariafocus.focusSafely)(ref.current);
                        else {
                            walker.currentNode = ref.current;
                            focusable1 = direction === "rtl" ? $cf2021be63b01ef4$var$last(walker) : walker.firstChild();
                            if (focusable1) (0, $2oePb$reactariafocus.focusSafely)(focusable1);
                        }
                    }
                    break;
                }
