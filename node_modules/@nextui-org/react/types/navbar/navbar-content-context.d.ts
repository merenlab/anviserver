...
export declare const NavbarContentProvider: import("react").Provider<{
    ...
    repositionHighlight: (event: import("react").MouseEvent<HTMLElement, MouseEvent>, item: HTMLElement) => void;
    resetHighlight: () => void;
